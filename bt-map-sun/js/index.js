...
function clickableGrid(rows, cols, callback) {
    ...
    redTitle.colSpan = 3
    redTitle.innerHTML = "Red Team's Map"
...
/* function createButton2() {
    ...
    //THIS IS FOR TBL2 (BLUE MAP)
    var createdbtn2 = document.createElement('button');
    createdbtn2.setAttribute("id", "btn2")
    createdbtn2.className = "btn btn-block btn-danger"
    createdbtn2.innerHTML = "Launch Missile to Attack Blue Team!"
    createdbtn2.addEventListener('click', function () {

        if (number2 == 24) {
            alert("Hit")
            hitMiss = "Hit"
            displayResult2(number2, hitMiss)
